...
if __name__ == "__main__":
    ...
    gpt_size = "gpt2-large"
    output_dir = f"/data/jjyu/RE_Sentence_Generation/Fine_tuned_model/{args.dataset}/scale{args.scale}_seed{args.seed}_{args.prompt}/{gpt_size}"
    if not os.path.isdir(output_dir):
        os.makedirs(output_dir)


    PLM_path = f"./pretrained/from_huggingface/{gpt_size}/"
    dir_kwargs = dict(
        data_dir=data_dir,
